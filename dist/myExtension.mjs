...
var en$1 = {
	...
	"myExtension.entry.description": "Do it in JavaScript"
};
var ja$1 = {
	"myExtension.entry.name": "マイ拡張",
	"myExtension.entry.description": "JavaScriptを実行する"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"myExtension.entry.name": "まいかくちょう",
	"myExtension.entry.description": "ジャバスクリプトをじっこうする"
}
};
...
var entry = {
  ...
  extensionURL: 'https://myaccount.github.io/my-extension/dist/myExtension.mjs',
  collaborator: 'myaccount',
  iconURL: img$2,
  insetIconURL: img$1,
  get description() {
    return "".concat(formatMessage$1({
      defaultMessage: 'my extension for Xcratch',
  ...
  helpLink: 'https://myaccount.github.io/my-extension/',
 ...
 * @type {string}
 */
var extensionURL = 'https://myaccount.github.io/my-extension/dist/myExtension.mjs';
      ...
      return {
        ...
        blocks: [{
          ...
          text: formatMessage({
            ...
            description: 'execute javascript for my extension'
          }),
          func: 'doIt',
          arguments: {
            SCRIPT: {
